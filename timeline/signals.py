...
skips_classes_student = Signal(providing_args=['instance'])   # send a reminder to students skipping classes for a week
#
# i have made two different signals, because they obviously will require different
# options, like time, left to the lesson


@receiver(skips_classes_student, dispatch_uid='notify_skips_classes_student')
